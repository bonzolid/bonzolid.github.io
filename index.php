...
<head>
	...
	<meta charset="UTF-8">
	<title>Conjunto de entrenamiento de neopreno EasyTrainer</title>
	...
	<link rel="stylesheet" href="libs/stacktable/stacktable.css">
...
<body>
	...
	<section class="content">
			...
			<div class="container">
				<div class="row flex">
					...
					<div class="col-xl-6 col-lg-6 flex-item-bottom">
						<div class="left-side">
							<img class="main-logo" style="max-width: 300px;" src="img/logo.png">
								...
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 flex-middle">
									<form action="" method="post" class="site-form order_form">
										...
										<p class="price text-green">
											<small class="old-price price_old"><?= $oldPriceHtml ?> <?= $currencyDisplayHtml ?></small>
											<span class="price_main"><?= $newPriceHtml ?> <?= $currencyDisplayHtml ?></span>
										</p>
			...
			<div class="container">
				<div class="row flex">
					<div class="col-xl-6 col-lg-6 flex-middle">
					 ...
					 <div class="col-xl-6 col-lg-6 flex-middle right-image"><img src="img/s2_mobile.jpg"></div>
				</div>
			</div>
		</section>
		...
		<section class="section section-reviews" id="s14">
			<div class="container">
				<h2 class="text-white text-center">Comentarios de usuarios</h2>
