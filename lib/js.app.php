...
global $fieldJson, $language, $lang, $showcase_url, $disablePhoneMask, $formValidatorOptions;
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function() {
            ...
            var phoneValidatorArgs = {
                ...
                minLength: '<?= array_get($formValidatorOptions, 'phone_min_length') ?>',
                maxLength: '<?= array_get($formValidatorOptions, 'phone_max_length') ?>',
            }
        ...
        var isDisablePhoneMask = Boolean(<?= $disablePhoneMask ?>)
            || Boolean(<?= array_get($formValidatorOptions, 'disable_phone_mask') ?>);
        ...
        window.app = {
            ...
            disablePhoneMask: isDisablePhoneMask,
